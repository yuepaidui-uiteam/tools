...
const EN = {
  ...
  upload_limits: 'Select multiple images, 25 MB each. Supports JPG, PNG, and WebP.',
  ...
  quality_balanced: 'Balanced (80%)',
  quality_small: 'Smaller file (70%)',
...
export const DICTS = {
  ...
  'es-ES': dictionary({
    ...
    upload_limits: 'Selecciona varias imágenes, 25 MB cada una. Compatible con JPG, PNG y WebP.', local_choose_formats: 'o elige JPG, PNG, WebP desde este dispositivo', local_choose_png: 'o elige PNG / .9.png desde este dispositivo',
    ...
    quality_high: 'Alta calidad (90%)', quality_balanced: 'Equilibrado (80%)', quality_small: 'Archivo más pequeño (70%)', quality_custom: 'Personalizado', custom_quality: 'Calidad personalizada',
  ...
  'pt-BR': dictionary({
    ...
    upload_limits: 'Selecione várias imagens, 25 MB cada. Suporta JPG, PNG e WebP.', local_choose_formats: 'ou escolha JPG, PNG, WebP neste dispositivo', local_choose_png: 'ou escolha PNG / .9.png neste dispositivo',
    ...
    quality_high: 'Alta qualidade (90%)', quality_balanced: 'Equilibrado (80%)', quality_small: 'Arquivo menor (70%)', quality_custom: 'Personalizado', custom_quality: 'Qualidade personalizada',
  ...
  'fr-FR': dictionary({
    ...
    upload_limits: 'Sélectionnez plusieurs images, 25 Mo chacune. JPG, PNG et WebP.', local_choose_formats: 'ou choisissez JPG, PNG, WebP sur cet appareil', local_choose_png: 'ou choisissez PNG / .9.png sur cet appareil',
    ...
    quality_high: 'Haute qualité (90%)', quality_balanced: 'Équilibré (80%)', quality_small: 'Fichier plus petit (70%)', quality_custom: 'Personnalisé', custom_quality: 'Qualité personnalisée',
  ...
  'de-DE': dictionary({
    ...
    upload_limits: 'Mehrere Bilder auswählen, je 25 MB. Unterstützt JPG, PNG und WebP.', local_choose_formats: 'oder JPG, PNG, WebP von diesem Gerät wählen', local_choose_png: 'oder PNG / .9.png von diesem Gerät wählen',
    ...
    quality_high: 'Hohe Qualität (90%)', quality_balanced: 'Ausgewogen (80%)', quality_small: 'Kleinere Datei (70%)', quality_custom: 'Benutzerdefiniert', custom_quality: 'Benutzerdefinierte Qualität',
  ...
  'nl-NL': dictionary({
    ...
    upload_limits: 'Meerdere afbeeldingen kiezen, 25 MB per stuk. JPG, PNG en WebP.', local_choose_formats: 'of kies JPG, PNG, WebP op dit apparaat', local_choose_png: 'of kies PNG / .9.png op dit apparaat',
    ...
    quality_high: 'Hoge kwaliteit (90%)', quality_balanced: 'Gebalanceerd (80%)', quality_small: 'Kleiner bestand (70%)', quality_custom: 'Aangepast', custom_quality: 'Aangepaste kwaliteit',
  ...
  'ja-JP': dictionary({
    ...
    upload_limits: '複数選択可能、各 25 MB。JPG、PNG、WebP 対応。', local_choose_formats: 'またはこの端末から JPG、PNG、WebP を選択', local_choose_png: 'またはこの端末から PNG / .9.png を選択',
    ...
    quality_high: '高品質 (90%)', quality_balanced: 'バランス (80%)', quality_small: '小さいファイル (70%)', quality_custom: 'カスタム', custom_quality: 'カスタム品質',
  ...
  'ko-KR': dictionary({
    ...
    upload_limits: '여러 이미지 선택 가능, 각 25 MB. JPG, PNG, WebP 지원.', local_choose_formats: '또는 이 기기에서 JPG, PNG, WebP 선택', local_choose_png: '또는 이 기기에서 PNG / .9.png 선택',
    ...
    quality_high: '고품질 (90%)', quality_balanced: '균형 (80%)', quality_small: '더 작은 파일 (70%)', quality_custom: '사용자 지정', custom_quality: '사용자 지정 품질',
  ...
  'zh-CN': dictionary({
    ...
    files_count: '{count} 个文件', file_count: '{count} 个文件', choose_files: '选择文件', choose_image: '选择图片', choose_folder: '选择文件夹', drop_files: '拖入图片到这里', drop_png: '拖入图片到这里',
    upload_limits: '可选择多张图片，每张不超过 25 MB，支持 JPG、PNG 和 WebP。', local_choose_formats: '或从本机选择 JPG、PNG、WebP', local_choose_png: '或从本机选择 PNG / .9.png',
    ...
    quality_high: '高清（90%）', quality_balanced: '均衡（80%）', quality_small: '更小文件（70%）', quality_custom: '自定义', custom_quality: '自定义质量',
